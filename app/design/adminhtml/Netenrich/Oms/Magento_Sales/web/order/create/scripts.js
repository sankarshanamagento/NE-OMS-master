    ...
    AdminOrder.prototype = {
        ...
        selectCustomer : function(grid, event){
            ...
            if (element.title){
				...
				this.setCustomerId(res[0]);
				this.setStoreId(res[1]);
            ...
            if (indicator) {
                ...
                new Ajax.Request(url, {
                    ...
                    onSuccess: function(transport) {
                        ...
                        this.loadAreaResponseHandler(response);
                      //  jQuery('#order-shipping_address_customer_address_id option:eq(1)').attr("selected","selected");
                        jQuery('#order-shipping_method').hide(); 
                        //var selectvalues=jQuery('#order-shipping_address_customer_address_id option:eq(1)').val();
                        //this.fillAddressFields('order-shipping_address_fields', this.addresses[selectvalues]);
                        deferred.resolve();
                    }.bind(this)
                });
            }
