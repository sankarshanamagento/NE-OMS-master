...

{
		...
		protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
		...
		$allifilation=$this->getInvoiceDistributor($order->getCustomerId());
        $page->drawText('Distributor:'.$allifilation, 285, $this->y, 'UTF-8');
	...
	public function getInvoiceDistributor($customerId)
   {
