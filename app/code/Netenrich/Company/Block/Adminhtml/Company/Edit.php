...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Netenrich_Company::company_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('company')->getId()) {
            return __("Edit Company '%1'", $this->escapeHtml($this->_coreRegistry->registry('company')->getTitle()));
        } else {
    ...
    {
        return $this->getUrl('company/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
