...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
	...
	{
		$options=trim($optionlabel);
		$string=strtoupper($optionlabel);
	...
	public function callapis($data_string)
	{
		...
		$service_url = 'https://divastg.netenrich.com/webhook/magentoAttributeSync';
		...
		{
			$returnarray['status']=$decoded->status;
			$returnarray['jobid']=$decoded->response->jobUniqueId;
	...
	public function Servicesapis($data_string)
	{
		...
		$service_url = 'https://divastg.netenrich.com/webhook/magentoServiceSync';
		$curl = curl_init($service_url);
